...
namespace AvalonDock.MVVMTestApp
{
    public class Workspace : ViewModelBase
    {
        ...
        public WPFOpenGLLib.OpenGLHwnd OpenGl2Md2 = null;
        ...
        PieceListInfoViewModel _PieceListInfo = null;
        public PieceListInfoViewModel PieceListInfo
        {
            get
            {
                if (_PieceListInfo == null)
                    _PieceListInfo = new PieceListInfoViewModel();
